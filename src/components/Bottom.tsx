...
const Bottom: FunctionComponent<BottomType> = ({ className = "" }) => {
  return (
    <div className={[styles.bottom, className].join(" ")}>
      <div className={styles.logoContainer}>
        <div className={styles.logoColored}>
          ...
          <b className={styles.viewio}>viewio</b>
          <img className={styles.vectorIcon5} alt="" src="/vector-6.svg" />
        </div>
      </div>
      ...
      <div className={styles.appDownload}>
        ...
        <div className={styles.button1}>
          <div className={styles.googlePlay}>
            <img className={styles.vectorIcon6} alt="" src="/vector-9.svg" />
            <img className={styles.vectorIcon7} alt="" src="/vector-10.svg" />
            <div className={styles.getItOn}>GET IT ON</div>
            <img className={styles.vectorIcon8} alt="" src="/vector-11.svg" />
            <img className={styles.vectorIcon9} alt="" src="/vector-12.svg" />
            <img className={styles.vectorIcon10} alt="" src="/vector-13.svg" />
            <img className={styles.vectorIcon11} alt="" src="/vector-14.svg" />
            <img className={styles.vectorIcon12} alt="" src="/vector-15.svg" />
          </div>
        </div>
      </div>
